...
quoi que ce soit. Claude voit ensuite les issues et corrige.
...
# 1) Jeton GitHub « fine-grained » avec la permission Issues: Read and write
#    sur le dépôt dg280/iil (https://github.com/settings/tokens?type=beta)
...
contexte (écran, version/build, univers, etc.). Si le worker est injoignable,
l'app retombe automatiquement sur le partage natif / l'e-mail au parent.
